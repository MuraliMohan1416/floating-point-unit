...
set DESIGN_NAME 		"fpu_add" ;# Required; name of the design to be worked on; used as the block name for save_block or copy_block operations
...
set LINK_LIBRARY			" /home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_ss0p6v125c.db \
				          ...
				          /home1/14_nmts/14_nmts/stdcell_rvt/db_ccs/saed14rvt_ff0p7vm40c.db "	;# Optional; specify a list of .db files
...
set "TCL_LIB_CELL_DONT_USE_FILE" 		"../scripts/set_lib_cell_purpose.tcl" ;# A Tcl file which applies lib cell purpose related restrictions;
...
set CTS_LIB_CELL_PATTERN_LIST 		"*/*CLK* */*BUF_S_2 */*BUF_S_4 */*BUF_S_6 */*BUF_S_8 */*FSD* " ;# List of CTS lib cell patterns to be used by CTS; 
...
set CTS_ONLY_LIB_CELL_PATTERN_LIST 	"*/*CLK*" ;# List of CTS lib cell patterns to be used by CTS "exclusively", such as clock specific
...
##################################################
set TCL_MCMM_SETUP_FILE "/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/inputs/mcmm/TCL_MCMM_SETUP_FILE.explicit.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set TCL_PARASITIC_SETUP_FILE	"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/inputs/mcmm/TCL_PARASITIC_SETUP_FILE.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;
...
##########################################################################################
set PLACE_OPT_ACTIVE_SCENARIO_LIST	"func::ss0p6v125c" ;# A subset of scenarios to be made active during place_opt step;
...
set CLOCK_OPT_CTS_ACTIVE_SCENARIO_LIST  "func::ss0p6v125c func::ff0p7vm40c func_turbo::ss0p6v125c" ;# A subset of scenarios to be made active during clock_opt_cts step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
set ROUTE_OPT_ACTIVE_SCENARIO_LIST 	"func::ssop6v125c func::ff0p7vm40c func_turbo::ss0p6v125c" ;# A subset of scenarios to be made active during route_opt step;
					;# once set, the list of active scenarios is saved and carried over to subsequent steps;
...
set VERILOG_NETLIST_FILES	"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/synth/fpu_add/outputs/fpu_add.mapped.v"	;# Verilog netlist files;
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is set to ASCII; not required for DC_ASCII or NDM

set UPF_FILE 			"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/inputs/fpu_add.upf"	;# A UPF file
					;# 	for DP: required
					;# 	for PNR: required if INIT_DESIGN_INPUT is set to ASCII; not required for DC_ASCII or NDM
...
set OUTPUTS_DIR	"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/outputs" ;# Directory to write output data files; mainly used by write_data.tcl
set REPORTS_DIR	"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/reports" ;# Directory to write reports; mainly used by report_qor.tcl
set LOGS_DIR	"/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/logs"  ;# Directory to logs; mainly used by Makefile*
