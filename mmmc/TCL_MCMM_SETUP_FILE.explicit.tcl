...
##############################################################################################
set path "../inputs"
set paths "/home1/PD06/SmuraliM/RM_FPU/RM/FPU/pnr/fpu_add/inputs/mmmc"
########################################
## Variables
########################################
## Mode constraints; expand the section as needed
set mode1 				"func" ;# name for mode1	
set mode_constraints($mode1)            "${path}/func.sdc" ;# for mode1 specific SDC constraints

set mode2				"func_turbo" ;# name for mode1	
set mode_constraints($mode2)            "${path}/func_turbo.sdc" ;# for mode2 specific SDC constraints



## Corner constraints; expand it as needed
set corner1 				"ff0p7vm40c" ;# name of corner1	
set corner_constraints($corner1)        "${paths}/ff0p7vm40c.tcl" ;# for corner1 specific SDC constraints 

set corner2 				"ss0p6v125c" ;# name of corner2	
set corner_constraints($corner2)        "${paths}/ss0p6v125c.tcl" ;# for corner2 specific SDC constraints 

## Scenario constraints; expand it as needed; "::" is used as the separator following time.scenario_auto_name_separator default
set scenario1 				"${mode1}::${corner2}" ;# scenario1 with mode1 and corner1
set scenario_constraints($scenario1)    "" ;# for scenario1 specific SDC constraints

set scenario2 				"${mode2}::${corner1}" ;# scenario1 with mode1 and corner2
...
set scenario_constraints($scenario3)    "" ;# for scenario2 specific SDC constraints
