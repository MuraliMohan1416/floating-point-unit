...
if {[shell_is_in_topographical_mode]} {
   ...
   create_clock -period 1.333 -name MAIN [get_ports rclk]
...
#set_scenario_options -setup true -hold false -dynamic_power true -leakage_power true

 # report_scenario_options

} else {
    create_clock -period 1.666 -clock MAIN [get_ports rclk]
...
#set_scenario_options -setup false  -hold true -dynamic_power true -leakage_power true
